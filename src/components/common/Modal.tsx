...
export default function Modal({
  ...
  return (
    <>
      ...
      <div className="absolute left-1/2 top-1/2 z-10 w-1/2 -translate-x-1/2 -translate-y-1/2 transform overflow-y-auto overflow-x-hidden rounded-lg bg-white shadow dark:bg-gray-700">
